  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 md:px-6 py-12">
      <div className="max-w-3xl w-full">
          ...
          <div>
            <p
              className={`text-xs font-medium uppercase tracking-wider ${
                isWhiteBackground ? "text-slate-500" : "text-slate-400"
              }`}
            >
              Focus → Conversion
            </p>
            ...
            >
              Final Sprint — 90-Day Conversion
            </h2>
          </div>
        </div>
        ...
        >
          Execute a focused 90-day campaign to convert your preparation into tangible offers.
          Track metrics ruthlessly and optimize your approach based on real feedback.
        </p>
        ...
        <div className="space-y-4">
          {[
            ...
            >
              ...
              <span className={isWhiteBackground ? "text-slate-600" : "text-slate-300"}>
                {item}
              </span>
            </div>
          ))}
